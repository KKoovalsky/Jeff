/**
 * @file    test_audio_sampler_with_dma.cpp
 * @brief   Tests the AudioSamplerWithDma.
...
/**
 * @defgroup AudioSamplerWithDmaTests     Tests of AudioSamplerWithDma
 * @{
 */
...
/** @} */ // End of group AudioSamplerWithDmaTests
